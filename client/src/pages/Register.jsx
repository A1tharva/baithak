    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg-primary)] px-4 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-md animate-fadeIn z-10">
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-3xl font-extrabold text-[var(--text-primary)] tracking-tight">Join Baithak</h1>
          <p className="text-[var(--text-muted)] mt-2 font-medium">Create your profile and start chatting</p>
        </div>
        ...
        <div className="bg-[var(--bg-secondary)] border border-[var(--border)] rounded-3xl p-8 shadow-2xl backdrop-blur-xl bg-opacity-80">
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-sm font-semibold text-[var(--text-secondary)] mb-2 px-1">Username</label>
              <input
                name="username"
                type="text"
                required
            ...
            <div>
              <label className="block text-sm font-semibold text-[var(--text-secondary)] mb-2 px-1">Password</label>
              <input
                name="password"
                type="password"
                required
